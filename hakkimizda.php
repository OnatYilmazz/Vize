               ...
               <div id="page-slider" class="owl-carousel owl-theme page-slider small-bg">
                     ...
                     <div class="container">
                        <div class="box-slider-content">
                           <div class="box-slider-text">
                              <h2 class="box-slide-title">LİDERLİK</h2>
                           </div>    
                        </div>
                     </div>
                  </div><!-- Item 1 end -->
                  ...
                  <div class="item" style="background-image:url(images/slider-pages/slide-page2.jpg)">
                     <div class="container">
                        <div class="box-slider-content">
                           <div class="box-slider-text">
                              <h2 class="box-slide-title">İLİŞKİLER</h2>
                           </div>    
                        </div>
                     </div>
                  </div><!-- Item 1 end -->
                  ...
                  <div class="item" style="background-image:url(images/slider-pages/slide-page3.jpg)">
                     <div class="container">
                        <div class="box-slider-content">
                           <div class="box-slider-text">
                              <h2 class="box-slide-title">VERİM</h2>
                           </div>    
                        </div>
                     </div>
                  </div><!-- Item 1 end -->
            ...
            <div class="facts-wrapper">
               ...
               <div class="col-sm-3 ts-facts">
                  ...
                  <div class="ts-facts-content">
                     ...
                     <h3 class="ts-facts-title">üyelerimiz</h3>
                  </div>
               </div><!-- Col end -->
               ...
               <div class="col-sm-3 ts-facts">
                  ...
                  <div class="ts-facts-content">
                     ...
                     <h3 class="ts-facts-title">yapılan proje</h3>
                  </div>
               </div><!-- Col end -->
   ...
   <section id="ts-team" class="ts-team">
      <div class="container">
         <div class="row text-center">
            ...
            <h3 class="section-sub-title">Ekibimiz</h3>
         </div><!--/ Title row end -->
