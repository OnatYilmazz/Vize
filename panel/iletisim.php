              ...
              <form role="form">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" value="<?php echo $ayarcek['email']?>"
                  </div>


                  <div class="form-group">
                    <label for="exampleInputEmail1">telefon</label>
                    <input type="email" class="form-control" value="<?php echo $ayarcek['telefon']?>"
                  </div>


                  <div class="form-group">
                    <label for="exampleInputEmail1">adres</label>
                    <input type="email" class="form-control" value="<?php echo $ayarcek['adres']?>"
                  </div>
